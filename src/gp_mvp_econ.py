...
class BasinExplorationGP:
    ...
    def add_well(self, location, measurements, well_name=None):
        ...
        well_data = {
            ...
            'date_added': len(self.wells)  # Simple proxy for time
        }
